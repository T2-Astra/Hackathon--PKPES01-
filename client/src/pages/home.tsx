          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col gap-3 justify-center mb-16 sm:hidden">
              ...
              <div className="flex flex-row gap-3 justify-center">
                <Button
                  ...
                  className="cursor-target border-border hover:bg-accent text-foreground px-4 py-2 text-sm font-medium flex-1"
              ...
              <SmoothDrawer
                ...
                triggerClassName="cursor-target bg-primary hover:bg-primary/90 text-primary-foreground border-primary px-4 py-2 text-sm font-medium w-full"
                feature1="Question Papers & Notes"
                feature2="AI Study Assistant"
                feature3="Video Lectures"
                feature4="Upload Notes"
                onPrimaryAction={() => scrollToSearch()}
                primaryButtonText="Start Exploring"
                tertiaryButtonText="Know More"
                onTertiaryAction={() => setLocation('/about')}
            ...
            <div className="hidden sm:flex flex-row gap-4 justify-center mb-16">
              ...
              <SmoothDrawer
                triggerText="Platform Features"
                triggerVariant="outline"
                triggerClassName="cursor-target bg-primary hover:bg-primary/90 text-primary-foreground border-primary px-8 py-3 text-base font-medium"
                feature1="Question Papers & Notes"
                feature2="AI Study Assistant"
                feature3="Video Lectures"
                feature4="Upload Notes"
              ...
              <Button
                variant="outline"
                onClick={scrollToSearch}
                className="cursor-target border-border hover:bg-accent text-foreground px-8 py-3 text-base font-medium"
                data-testid="button-quick-search"
              >
                {t.home.quickAccess}
              </Button>
      ...
      <section id="resources" className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link href="/search?type=question-papers">
              <Button
                variant="outline"
                className="cursor-target border-border hover:bg-accent text-foreground px-8 py-3 font-medium"
